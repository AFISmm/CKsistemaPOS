          ...
          <button
            ...
            className={`flex min-h-[96px] flex-col items-start justify-between rounded-xl border p-3 text-left shadow-sm transition active:scale-95 ${
              agotado
                ...
                : "border-neutral-200 bg-white hover:border-ck-red hover:shadow-md"
            }`}
          >
            <span className="text-sm font-semibold leading-snug text-ck-dark">
              {prod.nombre}
            </span>
            <div className="mt-2 flex w-full items-center justify-between">
              <span className="text-base font-bold text-ck-red">
